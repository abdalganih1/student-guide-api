                ...
                {{-- Example for specialization dropdown --}}
                 ...
                 <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control @error('year') is-invalid @enderror" id="year" name="year" value="{{ old('year', $project->year) }}" required min="2000" max="{{ date('Y') + 2 }}">
                     ...
                     <div class="col-md-4 mb-3">
                         ...
                         <select class="form-select @error('semester') is-invalid @enderror" id="semester" name="semester" required>
                            ...
                            <option value="خريف" {{ old('semester', $project->semester) == 'خريف' ? 'selected' : '' }}>خريف</option>
                            <option value="ربيع" {{ old('semester', $project->semester) == 'ربيع' ? 'selected' : '' }}>ربيع</option>
                            <option value="صيف" {{ old('semester', $project->semester) == 'صيف' ? 'selected' : '' }}>صيف</option>
                        </select>
